...
class CreateExpenseSafeTransaction extends BaseCreateRecord
{
    ...
    {
        return 'Kasa Çıkış İşlemi Oluştur';
    }
    ...
    public function form(Schema $form): Schema
    {
        return $form
            ->schema([
                Schemas\Components\Section::make('Kasa Çıkış Bilgileri')
                    ->description('Çıkış yapılan kasa bilgileri')
